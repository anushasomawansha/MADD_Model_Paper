...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public List readAllInfo(String username){
        ...
        while(cursor.moveToNext()) {
            String user = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_NAME_1));
            String dob = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_NAME_2));
            String pass = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_NAME_3));
            String gender = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_NAME_4));
            userInfo.add(user); //0
            userInfo.add(dob);  //1
            userInfo.add(pass); //2
